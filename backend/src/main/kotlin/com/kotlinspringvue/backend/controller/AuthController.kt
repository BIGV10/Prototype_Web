...
import com.kotlinspringvue.backend.model.SignupUser
...
class AuthController {
    ...
    @PostMapping("/signin")
    fun authenticateUser(@Valid @RequestBody loginRequest: User): ResponseEntity<*> {
...
//        else
    ...
    @PostMapping("/signup")
    fun registerUser(@Valid @RequestBody newUser: SignupUser): ResponseEntity<*> {
